  ...
  try {
    ...
    if (needCLodop() || isLinuxX86 || isLinuxARM) {
      ...
      if (!LODOP) {
        ...
        if (isLinuxX86 && LODOP.CVERSION < '7.0.7.5') strAlertMessage = strLodop7Update_X86
        else if (isLinuxARM && LODOP.CVERSION < '7.0.7.5') strAlertMessage = strLodop7Update_ARM
        else if (CLODOP.CVERSION < '6.5.9.3') strAlertMessage = strCLodopUpdate
