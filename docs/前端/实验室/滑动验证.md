...
| 参数          |      类型      |         说明          |     默认值      |
| ------------- | :------------: | :-------------------: | :-------------: |
| cWidth        | Number、String |         宽度          |       500       |
| cHeight       | Number, String |         高度          |       44        |
| isCircle      |    Boolean     |         圆角          |      false      |
| isAnima       |    Boolean     |         动画          |      true       |
| text          |     String     |       背景文案        |  向右拖动验证   |
| successText   |     String     |     验证通过文案      |    验证通过     |
| background    |     String     |    背景文案-背景色    |      #eee       |
| progressBarBg |     String     |    滑动覆盖-背景色    |     #FFEFC9     |
| handlerBg     |     String     |    可移动块-背景色    |     #ff9f14     |
| handlerIcon   |     String     |     可移动块图标      | base64 默认箭头 |
| successIcon   |     String     | 可移动块-成功状态图标 | base64 默认钩子 |
